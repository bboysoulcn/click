...
一个基于 Python 实现的点赞/喜欢按钮系统，注重隐私保护，适用于博客、数字花园、作品集或任何网站。无需注册账号，不追踪用户。

灵感来源于 [iine](https://github.com/welpo/iine)。
...
```html
<script defer src="http://你的域名.com/static/click.js"></script>
```
...
```html
<link rel="stylesheet" href="http://你的域名.com/static/click.css">
```
...
<button class="click-button" data-icon="heart" aria-hidden="true"></button>
<button class="click-button" data-icon="thumbs_up" aria-hidden="true"></button>
<button class="click-button" data-icon="upvote" aria-hidden="true"></button>

<!-- 任意 emoji -->
<button class="click-button" data-icon="💯" aria-hidden="true"></button>
<button class="click-button" data-icon="🎉" aria-hidden="true"></button>
```
...
<button class="click-button" data-slug="/custom-page" aria-hidden="true"></button>
<button class="click-button" data-slug="/section-1" aria-hidden="true"></button>
```

### 自定义标签

```html
<button class="click-button" aria-label="喜欢这篇文章" aria-hidden="true"></button>
```
